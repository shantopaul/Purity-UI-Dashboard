...
| :--- | :--- | :---: | :---: | :--- | :--- |
| **F01** | Setup & Design System Initialization | Small | `Pending` | - | - |
| **F02** | Layout Architecture & Navigation | Medium | `Pending` | - | - |
| **F03** | Dashboard Analytics & Charts | Large | `Pending` | - | - |
| **F04** | Tables Page UI | Medium | `Pending` | - | - |
| **F05** | Billing UI & Transactions | Medium | `Pending` | - | - |
